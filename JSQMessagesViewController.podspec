Pod::Spec.new do |s|
	...
	s.license = 'MIT'
	s.platform = :ios, '7.0'
	s.homepage = "https://github.com/abdullahumer/JSQMessagesViewController"
	s.author = 'Jesse Squires'

	s.source = { :git => 'https://github.com/abdullahumer/JSQMessagesViewController.git', :tag => s.version }
